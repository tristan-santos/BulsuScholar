...
const FAQS = [
	...
	{ roles: ["student"], category: "Applications", question: "Why can I not apply to another scholarship?", answer: "You may apply to multiple eligible grantors before commitment. Requesting materials commits you to one scholarship and closes competing applications. A grantor-specific rejection cooldown, archive block, full offering, or eligibility rule can still disable an application." },
