...
export default function HelpSupportPage() {
	...
	const submitFeedback = async (event) => {
		...
		try { await submitSupportFeedback({ ...feedback, userId, userType }); setFeedback({ category: "general", email: "", message: "" }); toast.success("Your help request was sent to system support.") }
